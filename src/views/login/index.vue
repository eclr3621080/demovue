...
<script>
  ...
  export default {
    ...
    created() {
      this.loginForm.employeeNo = getCookie("employeeNo");
      this.loginForm.secret = getCookie("secret");
      if(this.loginForm.employeeNo === undefined||this.loginForm.employeeNo==null||this.loginForm.employeeNo===''){
        this.loginForm.employeeNo = '1';
      }
      if(this.loginForm.employeeNo === undefined||this.loginForm.secret==null){
        this.loginForm.secret = '';
      }
    },
    methods: {
      showPwd() {
        if (this.pwdType === 'secret') {
          this.pwdType = ''
        } else {
          this.pwdType = 'secret'
        }
        ...
        this.$refs.loginForm.validate(valid => {
          if (valid) {
            ...
            this.$store.dispatch('Login', this.loginForm).then(() => {
              ...
              console.log("a")
              this.loading = false;
              setCookie("employeeNo",this.loginForm.employeeNo,15);
              setCookie("secret",this.loginForm.secret,15);
